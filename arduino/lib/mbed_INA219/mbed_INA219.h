#ifndef _MBED_INA219_H_
#define _MBED_INA219_H_
...
enum { INA219_CONFIG_BVOLTAGERANGE_16V = (0x0000),  // 0-16V Range
...
enum { INA219_CONFIG_GAIN_1_40MV = (0x0000),   // Gain 1, 40mV Range
...
enum { INA219_CONFIG_BADCRES_9BIT = (0x0000),	// 9-bit bus res = 0..511
...
enum { INA219_CONFIG_SADCRES_9BIT_1S_84US = (0x0000),  // 1 x 9-bit shunt sample
       INA219_CONFIG_SADCRES_10BIT_1S_148US =
	   (0x0008),  // 1 x 10-bit shunt sample
       INA219_CONFIG_SADCRES_11BIT_1S_276US =
	   (0x0010),  // 1 x 11-bit shunt sample
...
enum { INA219_CONFIG_MODE_POWERDOWN = 0x00, /**< power down */
...
class mbed_INA219 {
	...
	void write(char addr, uint16_t val);
	int16_t read(char addr);
