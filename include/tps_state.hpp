...
const unsigned long Inactive_Sense_Period = 250;
...
const unsigned long Sensing_Current_Period = 125;
/// How often (period) should the alternate load be checked, transitions to MeasuringAlternate
const unsigned long Sensing_Alternate_Period = 250;
...
/// How often (period) should the screen be updated
const unsigned long Measuring_Screen_Update_Period = 250;

/// Load simulator expected value period
const unsigned long LoadSimulator_Value_Period = 5000;
/// Number of steps
const int LoadSimulator_Value_Steps = 4;
